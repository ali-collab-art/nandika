...
export default function FinancesPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Financial Map</h1>
       ...
       <Card className="flex flex-col items-center justify-center text-center p-10 min-h-[400px]">
        ...
        <CardContent>
            <p className="text-muted-foreground">We are working hard to bring you the Financial Map feature. Stay tuned!</p>
        </CardContent>
      </Card>
    </div>
  );
